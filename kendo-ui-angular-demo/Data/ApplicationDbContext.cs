using kendo_ui_angular_demo.Models;
using Microsoft.EntityFrameworkCore;

namespace kendo_ui_angular_demo.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public virtual DbSet<CustomerDemo> CustomerDemo { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=TelerikKendoUIDemo01;Trusted_Connection=True;MultipleActiveResultSets=true");
            }
        }
